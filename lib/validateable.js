...
Validateable.prototype.isIn = function(options){
  this.validators.push(new validator.MembershipValidator(options));
  return this;
}
Validateable.prototype.matches = function(options){
  this.validators.push(new validator.RegexValidator(options));
  return this;
}
...
exports.Validateable = Validateable;
exports.create = Validateable.create;
